...
def addOptionalBooleanEntry(lines, dictionary, key, whitelist):
    if key not in dictionary:
        return
...
for filePath in projects:
    ...
    addOptionalUrlLine(lines, project, "publish_url")
    ...
    addOptionalBooleanEntry(lines, project, "featured", ["true", "false"])
